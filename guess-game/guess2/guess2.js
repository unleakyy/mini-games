...
let test1 = (Math.floor(Math.random() * 5) + 1);
...
function setTimeout1() {
    setTimeout(() => {
        ...
        setTimeout(() => {
            if (user == test1) {
                newNode.textContent = `Final round next! Good luck!!`;
                setTimeout(() => {
                    window.location.href = '../guess3/guess3.html';
                }, 2000);
            } else {
                newNode.textContent = `Aww. Nice try, though. Bawi ka!`;
